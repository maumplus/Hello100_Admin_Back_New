namespace Hello100Admin.Modules.Admin.Application.Features.ServiceUsage.Responses.GetUntactMedicalHistory
{
    public sealed record GetUntactMedicalHistoryResponse
    {
        ...
        public List<GetUntactMedicalHistoryDetailInfo> DetailList { get; init; } = default!;
    }

    public sealed record GetUntactMedicalHistoryDetailInfo
    {
