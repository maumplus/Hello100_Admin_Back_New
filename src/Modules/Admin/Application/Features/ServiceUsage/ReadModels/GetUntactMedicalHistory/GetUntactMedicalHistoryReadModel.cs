namespace Hello100Admin.Modules.Admin.Application.Features.ServiceUsage.ReadModels.GetUntactMedicalHistory
{
    public sealed class GetUntactMedicalHistoryReadModel
    {
        ...
        public List<GetUntactMedicalHistoryDetailReadModel> DetailList { get; set; } = default!;
    }

    public sealed class GetUntactMedicalHistoryDetailReadModel
    {
