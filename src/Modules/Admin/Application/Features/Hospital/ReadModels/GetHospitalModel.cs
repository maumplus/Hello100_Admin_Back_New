...
namespace Hello100Admin.Modules.Admin.Application.Features.Hospital.ReadModels
{
    public class GetHospitalModel
    {
        ...
        public List<GetHospMedicalTimeModel> ClinicTimes { get; set; }
        public List<GetHospitalMedicalModel> DeptCodes { get; set; }
        public List<GetHospitalMedicalModel> DeptCodesAll { get; set; }
        public List<GetHospKeywordModel> Keywords { get; set; }
        public List<GetImageModel> Images { get; set; }
        public List<GetHospMedicalTimeNewModel> ClinicTimeNews { get; set; }
        public List<GetKeywordMasterModel> KeywordMasters { get; set; }
    }
}
