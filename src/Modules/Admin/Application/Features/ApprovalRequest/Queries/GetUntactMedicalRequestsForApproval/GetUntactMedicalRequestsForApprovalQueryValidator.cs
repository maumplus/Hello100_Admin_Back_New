...
{
    public class GetUntactMedicalRequestsForApprovalQueryValidator : AbstractValidator<GetUntactMedicalRequestsForApprovalQuery>
    {
        public GetUntactMedicalRequestsForApprovalQueryValidator()
        {
            RuleFor(x => x.PageNo)
