...
{
    internal sealed class GetUntactMedicalHistoryRow
    {
        ...
        public List<GetUntactMedicalHistoryDetailRow> DetailList { get; set; } = default!;
    }

    internal sealed class GetUntactMedicalHistoryDetailRow
    {
