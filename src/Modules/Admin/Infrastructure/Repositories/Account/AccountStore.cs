...
namespace Hello100Admin.Modules.Admin.Infrastructure.Repositories.Account
{
    public class AccountStore : IAccountStore
    {
        ...
        public async Task<List<TbCommonEntity>> GetCommonList(string clsCd, CancellationToken cancellationToken = default)
        {
            var parameters = new DynamicParameters();
            parameters.Add("@ClsCd", clsCd, DbType.String);
            ...
            return (await connection.QueryAsync<TbCommonEntity>(sql, parameters)).ToList();
        }
    }
}
