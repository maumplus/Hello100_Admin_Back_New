...
/// 회원정보 엔티티 (tb_user)
/// </summary>
public class MemberEntity : AggregateRoot<string>
{
    /// <summary>
    /// 고객아이디 
    /// </summary>
    ...
    private readonly List<MemberFamilyEntity> _members = new();

    /// <summary>
    /// 고객의 멤버 목록 (가족 구성원 등)
    /// </summary>
    public IReadOnlyCollection<MemberFamilyEntity> Members => _members.AsReadOnly();

    /// <summary>
    /// 멤버 컬렉션을 주입하는 팩토리 메서드
    /// </summary>
    public MemberEntity WithMembers(IEnumerable<MemberFamilyEntity> members)
    {
        _members.Clear();
...
/// 멤버정보 엔티티 (tb_member)
/// </summary>
public class MemberFamilyEntity : AggregateRoot<int>
{
    /// <summary>
