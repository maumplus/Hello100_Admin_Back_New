...
{
    public sealed record PatchDoctorWeeksScheduleInfo
    {
        /// <summary>
        /// 요일순번
        /// </summary>
    ...
    public sealed record PatchDoctorWeeksScheduleRequest
    {
        /// <summary>
        /// 요양기관번호
        /// </summary>
        ...
        /// 주간 스케줄 목록
        /// </summary>
        public required List<PatchDoctorWeeksScheduleInfo> DoctorScheduleList { get; init; }
    }

    public sealed record PatchMyDoctorWeeksScheduleRequest
    {
        /// <summary>
        /// 의사사번
        /// </summary>
        ...
        /// 주간 스케줄 목록
        /// </summary>
        public required List<PatchDoctorWeeksScheduleInfo> DoctorScheduleList { get; init; } = default!;
    }
}
