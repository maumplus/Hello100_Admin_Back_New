namespace Hello100Admin.Integration.Shared
{
    public static class HttpClientAuthExtensions
    {
        ...
        public static HttpClient AsSuperAdmin(this HttpClient client, string userId = "TEST5678", string name = "슈퍼테스트", string hospNo = "13306651", string hospKey = "YzZjNzY4NjJjZTQzZTJlNjNkOTE0ZmJjMTEzMDdkMDI5ZjI5M2NiYWFiMjY0YjVhMDVmMTM4MTIxOGVlNGUyNQ==")
        {
            client.DefaultRequestHeaders.Remove(TestAuthHandler.HeaderName);
